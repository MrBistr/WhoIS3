...
// --- Demo data: from the team image (Image 3) ---
const teamDemo = [
  {
    id: "main-user",
    name: "YOU",
...
function setupDemoIfEmpty() {
    if (!localStorage.getItem('nodes')) {
        ...
        // Position nodes in a "network" around center
        ...
        // Position groups in outer circle
        ...
        // Connections: groups to YOU, cluster members to group, some inter-node lines
        const connections = [
        ...
        // Stop floating for connected nodes
...
// --- Hero "Get Started" button to hide hero and show FABs ---
...
// --- DRAG AND DROP for nodes (not main node) ---
...
function startDrag(e) {
    ...
    function onUp(ev) {
        ...
        // Check if dropped on another node or group
...
// --- Floating animation for unconnected nodes (not main-user) and groups ---
function floatNodes() {
